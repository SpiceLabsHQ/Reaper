...
- **Format**: .claude/worktrees/[task-id]-description (or project root)
...
Always exclude these patterns when running tests: `**/.claude/worktrees/**`, `**/*backup*/**`, `**/node_modules/**`, `**/vendor/**`, `**/.git/**`, `**/venv/**`, `**/target/**`.
...
```json
{
  "gate_status": "PASS",
  "task_id": "PROJ-123",
  "working_dir": ".claude/worktrees/PROJ-123-test",
