...
1. Implement performance optimization with TDD (Red-Green-Refactor)
...
4. The orchestrator will deploy quality gates: test-runner (full suite validation) then code-reviewer + security-auditor (parallel review)
