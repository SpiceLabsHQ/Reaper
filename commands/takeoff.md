...
you'd prefer to open a PR instead of merging directly, run `/reaper:ship <worktree-path>`
and I'll handle the commit, push, and PR creation for you.
```
...
| "open a PR" / "create PR" | Run `/reaper:ship <worktree-path>` to commit, push, and open a PR for the feature branch. |
